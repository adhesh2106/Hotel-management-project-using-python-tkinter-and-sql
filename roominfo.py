...
class RoomInfo:
    def __init__(self,root):
        ...
        self.root.geometry("1295x550+230+220")
         ...
         #######Title########
        lbtitle=Label(self.root,text="ROOM AMENITIES",font=("times new roman",18,"bold"),bg="black",fg="blue",bd=4,relief=RIDGE)
        ...
        ###Room amenities
        ####main frame img#######
        img6=Image.open(r"C:\Users\Dr.N.T.Murali Mohan\Desktop\Hotel project pics\room amenities.png")
